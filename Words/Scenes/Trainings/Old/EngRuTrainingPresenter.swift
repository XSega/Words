...
class EngRuTrainingPresenter: IEngRuTraining {
    ...
    fileprivate func displayPair() {
        ...
        view?.displayMeaning(text: meaning.text, translations: meaning.randomTranslations(), imageData: meaning.imageData, soundData: meaning.soundData)
    }
}
